...
//mongoose.connect('mongodb://127.0.0.1/project2'); //Local Copy of MongoDB cluster
mongoose.connect(process.env.CONNECTION_URI); //Heroku environment variable for MongoDB cluster
